...
import (
	...
	customtx "github.com/onchainengineer/tenacity/app/tx"
	...
	"github.com/onchainengineer/tenacity/app/ante"
	tenacityappparams "github.com/onchainengineer/tenacity/app/params"
	"github.com/onchainengineer/tenacity/app/wasmconfig"

	// unnamed import of statik for swagger UI support
	//_ "github.com/onchainengineer/tenacity/client/docs/statik"
)
...
var (
	_ servertypes.Application = (*TenacityApp)(nil)
)
...
// TenacityApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type TenacityApp struct {
	*baseapp.BaseApp
...
// NewTenacityApp returns a reference to an initialized Tenacity.
func NewTenacityApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig tenacityappparams.EncodingConfig,
...
func (app *TenacityApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *TenacityApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *TenacityApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *TenacityApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *TenacityApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *TenacityApp) ModuleAccountAddrs() map[string]bool {
...
func (app *TenacityApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Tenacity's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *TenacityApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Tenacity's InterfaceRegistry
func (app *TenacityApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *TenacityApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *TenacityApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *TenacityApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *TenacityApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *TenacityApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *TenacityApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *TenacityApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

// RegisterUpgradeHandlers returns upgrade handlers
func (app *TenacityApp) RegisterUpgradeHandlers(cfg module.Configurator) {}
...
func (app *TenacityApp) enforceStakingForVestingTokens(ctx sdk.Context, genesisState GenesisState) {
