...
func createTestApp(isCheckTx bool, tempDir string) (*tenacityapp.TenacityApp, sdk.Context) {
	app := tenacityapp.NewTenacityApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, tenacityapp.MakeEncodingConfig(),
